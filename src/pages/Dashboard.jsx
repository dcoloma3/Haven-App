              ...
              <div className="flex items-center gap-2 overflow-x-auto scrollbar-none pb-0.5">
                ...
                {expiringCertCount > 0 && (
                  <button
                    ...
                    className="flex-shrink-0 flex items-center gap-1.5 bg-amber-50 border border-amber-200 hover:bg-amber-100 rounded-xl px-3 py-1.5 transition-all"
                  >
                    ...
                    <span className="text-sm font-bold text-amber-700">{expiringCertCount}</span>
                    <span className="text-xs text-amber-600">Certs</span>
                  </button>
                )}
              </div>
            )
